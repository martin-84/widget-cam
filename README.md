...
| Edit URL              | http://ide.c9.io/martin84eh/nde-red-dashboard-widget |
| Github URL            | http://github.com/martin-84/widget-nde-red-dashbrd |
| Test URL              | https://preview.c9users.io/martin84eh/nde-red-dashboard-widget/widget.html |
...
$("body").append('<' + 'div id="myDivNdeRedDashbrd"><' + '/div>');
